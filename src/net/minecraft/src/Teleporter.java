                        ...
                        for(int j9 = 0; j9 < 3; j9++)
                        {
                            for(int k10 = 0; k10 < 4; k10++)
                            {
                                for(int l11 = -1; l11 < 4; l11++)
                                {
                                    ...
                                    if(l11 < 0 && !world.getBlockMaterial(j12, l12, j13).func_878_a() || l11 >= 0 && world.getBlockId(j12, l12, j13) != 0)
                                    {
                                        break label0;
                                    }
                                }
                        ...
                        for(int l5 = l1; l5 < l1 + 2; l5++)
                        {
                            ...
                            for(int k9 = 0; k9 < 4; k9++)
                            {
                                for(int l10 = -1; l10 < 4; l10++)
                                {
                                    ...
                                    int k12 = l4 + l10;
                                    int i13 = k3 + (k9 - 1) * j8;
                                    if(l10 < 0 && !world.getBlockMaterial(i12, k12, i13).func_878_a() || l10 >= 0 && world.getBlockId(i12, k12, i13) != 0)
                                    {
                                        break label1;
                                    }
                                }
