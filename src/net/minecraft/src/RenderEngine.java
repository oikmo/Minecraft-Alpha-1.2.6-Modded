...
public class RenderEngine
{
    ...
    public RenderEngine(TexturePackList texturepacklist, GameSettings gamesettings)
    {
        ...
        field_1604_f = new ArrayList<TextureFX>();
        urlToImageDataMap = new HashMap<String, ThreadDownloadImageData>();
        clampTexture = false;
        blurTexture = false;
    ...
    {
    	//System.out.println(urlToImageDataMap.get(s) + "hi");
        ThreadDownloadImageData threaddownloadimagedata = (ThreadDownloadImageData)urlToImageDataMap.get(s);
        if(threaddownloadimagedata != null)
        {
            threaddownloadimagedata.referenceCount--;
...
label1:
    ...
    public void refreshTextures()
    {
        ...
        for(Iterator<Integer> iterator = textureNameToImageMap.keySet().iterator(); iterator.hasNext(); setupTexture(bufferedimage, i))
        {
            i = ((Integer)iterator.next()).intValue();
            bufferedimage = (BufferedImage)textureNameToImageMap.get(Integer.valueOf(i));
        }

        for(Iterator<ThreadDownloadImageData> iterator1 = urlToImageDataMap.values().iterator(); iterator1.hasNext();)
        {
        ...
        for(Iterator<String> iterator2 = textureMap.keySet().iterator(); iterator2.hasNext();)
        {
    ...
    private java.util.List<TextureFX> field_1604_f;
