    ...
    implements IChunkProvider
{
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        field_4178_w = worldObj.func_4075_a().getTemperatures(field_4178_w, k + 8, l + 8, 16, 16);
        for(int i17 = k + 8; i17 < k + 8 + 16; i17++)
        {
            for(int l19 = l + 8; l19 < l + 8 + 16; l19++)
            {
                int j21 = i17 - (k + 8);
                int j22 = l19 - (l + 8);
                int k22 = worldObj.func_4083_e(i17, l19);
                double d1 = field_4178_w[j21 * 16 + j22] - ((double)(k22 - 64) / 64D) * 0.29999999999999999D;
                if(d1 < 0.5D && k22 > 0 && k22 < 128 && worldObj.getBlockId(i17, k22, l19) == 0 && worldObj.getBlockMaterial(i17, k22 - 1, l19).func_880_c() && worldObj.getBlockMaterial(i17, k22 - 1, l19) != Material.ice)
                {
