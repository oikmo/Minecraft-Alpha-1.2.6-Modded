...
public class NetworkManager
{
    ...
    public NetworkManager(Socket socket, String s, NetHandler nethandler) throws IOException
    {
        ...
        isRunning = true;
        readPackets = Collections.synchronizedList(new ArrayList<Packet>());
        dataPackets = Collections.synchronizedList(new ArrayList<Packet>());
        chunkDataPackets = Collections.synchronizedList(new ArrayList<Packet>());
