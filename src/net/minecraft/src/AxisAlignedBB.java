...
public class AxisAlignedBB
{
	...
	public static AxisAlignedBB getBoundingBox(double minX, double d1, double d2, double d3, 
			double d4, double d5)
	{
		return new AxisAlignedBB(minX, d1, d2, d3, d4, d5);
	}
	...
	public boolean isVectorInside(Vec3D vec3d)
	{
