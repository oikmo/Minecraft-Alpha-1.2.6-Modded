    ...
    implements KeyListener, MouseListener, MouseMotionListener, Runnable
{
    ...
    public CanvasIsomPreview()
    {
        ...
        field_1791_c = true;
        field_1788_f = true;
        field_1787_g = Collections.synchronizedList(new LinkedList<IsoImageBuffer>());
    ...
    public void func_1270_b(String s)
    {
        ...
        synchronized(field_1787_g)
        {
            ...
            for(int i = 0; i < 64; i++)
            {
                for(int j = 0; j < 64; j++)
                {
                    field_1786_h[i][j].func_888_a(worldObj, i, j);
                }
    ...
    private void func_1266_a(int i)
    {
        synchronized(field_1787_g)
        {
            ...
            for(int j = 0; j < 64; j++)
            {
                for(int k = 0; k < 64; k++)
                {
                    field_1786_h[j][k].func_888_a(worldObj, j, k);
                }
    ...
    private java.util.List<IsoImageBuffer> field_1787_g;
